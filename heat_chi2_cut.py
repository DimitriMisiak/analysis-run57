...
if __name__ == '__main__':
    ...
    for num in num_array:
        ...
        cut_ind,_ = heat_chi2_cut(num, chi2_thresh)
    ...
    for i,ax in enumerate(axis):
        ...
        ax.set_xlabel('Energy {} [ADU]'.format(lab))
        ax.loglog(energy_raw_ion[i], chi2_raw_ion[i], ls='none', marker='+', 
                  color='r', alpha=0.5)
        ax.loglog(energy_cut_ion[i], chi2_cut_ion[i], ls='none', marker='+', color='b')
